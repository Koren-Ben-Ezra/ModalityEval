...
# EVAL F: flip2LettersTextFilter_eval as IMAGE
    # JOB 1: p=0.05
    # JOB 2: p=0.1
    # JOB 3: p=0.15
    # JOB 4: p=0.25
...
#EVAL G: flip2LettersTextFilter_eval as TEXT
    # JOB 1: p=0.05
    # JOB 2: p=0.1
    # JOB 3: p=0.15
    # JOB 4: p=0.25
...
def flip2LettersTextFilter_IF_eval():
    ...
    def run_eval(p: float):
        ...
        metadata = {
            "test name": "flip2LettersTextFilter eval",
            "Model": multimodal_wrapper.model_name,
            "Dataset": dataset_wrapper.dataset_id,
            "Save Predictions": True,
        }
...
def flip2LettersTextFilter_TF_eval():
    ...
    metadata = {
        "test name": "flip2LettersTextFilter text eval",
        "Model": multimodal_wrapper.model_name,
        "Dataset": datasetWrapper.dataset_id,
        "Save Predictions": True,
    }
    ...
    if selected_task == "2":
        benchmark_manager.register_job(text_f=ShuffleWordTextFilter(p=0.1), inner_dir="flip2LettersTextFilterTF_p_0_15")
        benchmark_manager.register_job(text_f=ShuffleWordTextFilter(p=0.25), inner_dir="flip2LettersTextFilterTF_p_0.25")
        
    if selected_task == "3":
        benchmark_manager.register_job(text_f=ShuffleWordTextFilter(p=0.3), inner_dir="flip2LettersTextFilterTF_p_0.3")
        benchmark_manager.register_job(text_f=ShuffleWordTextFilter(p=0.35), inner_dir="flip2LettersTextFilterTF_p_0.35")
